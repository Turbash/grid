export const flexLevelConfigs = {
  ...
  20: {
    instructions:
      "Use all you knowledge of flexbox to place the fruits in the correct baskets",
    basketCSS: {
      display: "flex",
      flexDirection: "column-reverse",
      flexWrap: "wrap-reverse",
    ...
    acceptedAnswers: [
      ...
      "align-content: space-between;\nflex-wrap: wrap-reverse;\nflex-direction: column-reverse;\njustify-content: center;",
      "align-content:space-between;\nflex-wrap:wrap-reverse;\nflex-direction:column-reverse;\njustify-content:center;",
      "align-content: space-between; flex-wrap: wrap-reverse; flex-direction: column-reverse; justify-content: center;",
      "align-content:space-between; flex-wrap:wrap-reverse; flex-direction:column-reverse; justify-content:center;",
    ],
    fruits: [
      { type: "apple", initialPosition: 1, correctPosition: 2 },
